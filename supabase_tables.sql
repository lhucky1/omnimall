...
-- Go to your Supabase project, click on the "SQL Editor" in the left sidebar,
-- click "New query", paste the content below, and click "RUN".
...
DROP TRIGGER IF EXISTS on_seller_verifications_updated ON public.seller_verifications;
DROP FUNCTION IF EXISTS handle_updated_at;
DROP TABLE IF EXISTS seller_verifications;


-- Create the seller_verifications table with new fields
...
-- Allow admins to update verification statuses
...
-- Note: After running this, you must set your own user as an admin.
-- Find your UID in Authentication -> Users, then run this in a new SQL query:
-- UPDATE profiles SET is_admin = true WHERE uid = 'your-user-uid';
