...
import { User, LogIn, LogOut, Package, Menu, Search, Home, Info, MessageCircleQuestion, Store, Heart, ShoppingCart, ShieldCheck, BookOpen, ShieldQuestion, FileText, Users } from 'lucide-react';
